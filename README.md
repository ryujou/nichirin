...
<p align="center">（可将硬件照片放在 assets/nichirin.jpg）</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/UI-LVGL-1EAE98?style=flat-square" alt="lvgl">
...
> 基于 STM32G431 的视频+频谱流媒体与 LED 灯效系统，USB CDC 传输 80x160 RGB565 帧，LVGL 菜单驱动多模式灯效与参数设置。
...
小日轮是一个将 USB CDC 视频流、音频频谱与 LED 灯效融合的展示工程。设备端使用 ST7735 LCD 与 12 灯 LED 条显示内容，PC 端通过 Python GUI 发送视频帧与音频频谱数据。LVGL 菜单提供模式切换、等级调节、保存与流媒体状态查看。
